...
public class ValueOfAQuadratic {
	...
	//System.out.println(total);   
		...
		//(-5) good, it equaled 119.0
		//(0) good, it equaled 4.0
	System.out.println("at x = "+ x +" , the total is " + total);
	...
	/*   x=2.0 comes out to zero which is correct
	 	 x = 2/3 should be zero but java thinks x = 0. 
	 	 x = 0.6666666666666666 is fine though!?
	 */
